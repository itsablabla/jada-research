export const itIT = {
  ...
  searchPage: {
    ...
    pressToSubmit: "Premi Invio per inviare",
  ...
  mcp: {
    title: "Strumenti MCP",
    description: "Connetti server MCP (Model Context Protocol) esterni per dare all'IA accesso a strumenti esterni durante le conversazioni. Gli strumenti dei server connessi sono automaticamente disponibili durante la chat nei quaderni.",
    addServer: "Aggiungi server",
    addFirstServer: "Aggiungi il tuo primo server",
    editServer: "Modifica server MCP",
    addServerTitle: "Aggiungi server MCP",
    deleteServer: "Eliminare il server MCP?",
    deleteServerDesc: "Il server verrà rimosso e i suoi strumenti non saranno più disponibili nella chat.",
    name: "Nome",
    namePlaceholder: "es. Composio, Garza MCP",
    url: "URL",
    ...
    noServersDesc: "Aggiungi un server MCP per dare all'IA accesso a strumenti esterni come email, gestione file e altro.",
    testConnection: "Testa connessione",
    connected: "Connesso — {count} strumenti disponibili",
    failed: "Fallito",
    showTools: "Mostra {count} strumenti",
