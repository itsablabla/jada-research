export const zhCN = {
  ...
  mcp: {
    title: "MCP 工具",
    description: "连接外部 MCP（模型上下文协议）服务器，让 AI 在聊天对话中访问外部工具。已连接服务器的工具在笔记本聊天时自动可用。",
    addServer: "添加服务器",
    addFirstServer: "添加您的第一个服务器",
    editServer: "编辑 MCP 服务器",
    addServerTitle: "添加 MCP 服务器",
    deleteServer: "删除 MCP 服务器？",
    deleteServerDesc: "这将移除该服务器，其工具将不再在聊天中可用。",
    name: "名称",
    ...
    noServersDesc: "添加 MCP 服务器，让 AI 可以使用电子邮件、文件管理等外部工具。",
    testConnection: "测试连接",
    connected: "已连接 — {count} 个工具可用",
    failed: "失败",
    showTools: "显示 {count} 个工具",
    hideTools: "隐藏工具",
    active: "活跃",
    disabled: "已禁用",
    cancel: "取消",
