export const ptBR = {
  ...
  searchPage: {
    ...
    pressToSubmit: "Pressione Enter para enviar",
  ...
  mcp: {
    ...
    description: "Conecte servidores MCP (Model Context Protocol) externos para dar à IA acesso a ferramentas externas durante conversas de chat. Ferramentas de servidores conectados ficam automaticamente disponíveis ao conversar em cadernos.",
    addServer: "Adicionar Servidor",
    addFirstServer: "Adicione Seu Primeiro Servidor",
    editServer: "Editar Servidor MCP",
    addServerTitle: "Adicionar Servidor MCP",
    deleteServer: "Excluir Servidor MCP?",
    deleteServerDesc: "Isso removerá o servidor e suas ferramentas não estarão mais disponíveis durante o chat.",
    name: "Nome",
    namePlaceholder: "ex. Composio, Garza MCP",
    url: "URL",
    ...
    noServersDesc: "Adicione um servidor MCP para dar à IA acesso a ferramentas externas como e-mail, gerenciamento de arquivos e mais.",
    testConnection: "Testar Conexão",
    connected: "Conectado — {count} ferramentas disponíveis",
    failed: "Falhou",
    showTools: "Mostrar {count} ferramentas",
