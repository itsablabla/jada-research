export const frFR = {
  ...
  mcp: {
    title: "Outils MCP",
    description: "Connectez des serveurs MCP (Model Context Protocol) externes pour donner à l'IA accès à des outils externes lors des conversations. Les outils des serveurs connectés sont automatiquement disponibles lors du chat dans les carnets.",
    addServer: "Ajouter un serveur",
    addFirstServer: "Ajoutez votre premier serveur",
    editServer: "Modifier le serveur MCP",
    addServerTitle: "Ajouter un serveur MCP",
    deleteServer: "Supprimer le serveur MCP ?",
    deleteServerDesc: "Le serveur sera supprimé et ses outils ne seront plus disponibles dans le chat.",
    name: "Nom",
    ...
    noServersDesc: "Ajoutez un serveur MCP pour donner à l'IA accès à des outils externes comme l'email, la gestion de fichiers et plus.",
    testConnection: "Tester la connexion",
    connected: "Connecté — {count} outils disponibles",
    failed: "Échoué",
    showTools: "Afficher {count} outils",
