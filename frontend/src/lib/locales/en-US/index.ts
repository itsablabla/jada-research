export const enUS = {
  ...
  searchPage: {
    ...
    pressToSubmit: "Press Enter to submit",
  ...
  mcp: {
    title: "MCP Tools",
    description: "Connect external MCP (Model Context Protocol) servers to give the AI access to external tools during chat conversations. Tools from connected servers are automatically available when chatting in notebooks.",
    ...
    deleteServerDesc: "This will remove the server and its tools will no longer be available during chat.",
    name: "Name",
    namePlaceholder: "e.g. Composio, Garza MCP",
    url: "URL",
    ...
    noServersDesc: "Add an MCP server to give the AI access to external tools like email, file management, and more.",
    testConnection: "Test Connection",
    connected: "Connected — {count} tools available",
    failed: "Failed",
    showTools: "Show {count} tools",
