export const zhTW = {
  ...
  mcp: {
    title: "MCP 工具",
    description: "連接外部 MCP（模型上下文協議）伺服器，讓 AI 在聊天對話中存取外部工具。已連接伺服器的工具在筆記本聊天時自動可用。",
    addServer: "新增伺服器",
    addFirstServer: "新增您的第一個伺服器",
    editServer: "編輯 MCP 伺服器",
    addServerTitle: "新增 MCP 伺服器",
    deleteServer: "刪除 MCP 伺服器？",
    deleteServerDesc: "這將移除該伺服器，其工具將不再在聊天中可用。",
    name: "名稱",
    namePlaceholder: "例如 Composio、Garza MCP",
    url: "URL",
    ...
    noServersDesc: "新增 MCP 伺服器，讓 AI 可以使用電子郵件、檔案管理等外部工具。",
    testConnection: "測試連線",
    connected: "已連線 — {count} 個工具可用",
    failed: "失敗",
    showTools: "顯示 {count} 個工具",
    hideTools: "隱藏工具",
    active: "啟用中",
    disabled: "已停用",
    cancel: "取消",
