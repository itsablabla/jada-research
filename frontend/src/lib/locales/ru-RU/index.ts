export const ruRU = {
  ...
  mcp: {
    ...
    description: "Подключите внешние серверы MCP (Model Context Protocol), чтобы предоставить ИИ доступ к внешним инструментам во время чат-бесед. Инструменты подключённых серверов автоматически доступны при общении в блокнотах.",
    addServer: "Добавить сервер",
    addFirstServer: "Добавьте первый сервер",
    editServer: "Редактировать сервер MCP",
    addServerTitle: "Добавить сервер MCP",
    deleteServer: "Удалить сервер MCP?",
    deleteServerDesc: "Сервер будет удалён, и его инструменты больше не будут доступны в чате.",
    name: "Название",
    namePlaceholder: "напр. Composio, Garza MCP",
    url: "URL",
    ...
    noServersDesc: "Добавьте сервер MCP, чтобы ИИ получил доступ к внешним инструментам: почта, файлы и другое.",
    testConnection: "Проверить подключение",
    connected: "Подключено — {count} инструментов доступно",
    failed: "Ошибка",
    showTools: "Показать {count} инструментов",
