export const bnIN = {
  ...
  mcp: {
    title: "MCP টুলস",
    description: "বাহ্যিক MCP (Model Context Protocol) সার্ভার সংযুক্ত করুন যাতে AI চ্যাট কথোপকথনের সময় বাহ্যিক টুল ব্যবহার করতে পারে। সংযুক্ত সার্ভারের টুলগুলি নোটবুকে চ্যাট করার সময় স্বয়ংক্রিয়ভাবে উপলব্ধ।",
    addServer: "সার্ভার যোগ করুন",
    addFirstServer: "আপনার প্রথম সার্ভার যোগ করুন",
    editServer: "MCP সার্ভার সম্পাদনা করুন",
    addServerTitle: "MCP সার্ভার যোগ করুন",
    deleteServer: "MCP সার্ভার মুছবেন?",
    deleteServerDesc: "এটি সার্ভারটি সরিয়ে দেবে এবং এর টুলগুলি চ্যাটে আর উপলব্ধ থাকবে না।",
    name: "নাম",
    namePlaceholder: "যেমন Composio, Garza MCP",
    url: "URL",
    ...
    enabled: "সক্রিয়",
    noServersConfigured: "কোনো MCP সার্ভার কনফিগার করা হয়নি",
    noServersDesc: "AI-কে ইমেইল, ফাইল ম্যানেজমেন্ট এবং আরও অনেক বাহ্যিক টুলে অ্যাক্সেস দিতে একটি MCP সার্ভার যোগ করুন।",
    testConnection: "সংযোগ পরীক্ষা",
    connected: "সংযুক্ত — {count}টি টুল উপলব্ধ",
    failed: "ব্যর্থ",
    showTools: "{count}টি টুল দেখান",
    hideTools: "টুল লুকান",
    active: "সক্রিয়",
    disabled: "নিষ্ক্রিয়",
    cancel: "বাতিল",
